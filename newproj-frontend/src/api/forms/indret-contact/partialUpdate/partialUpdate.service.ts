...
@Injectable()
export class IndretContactPartialUpdateFormService extends YASAGPostFormService<__model.IndretContact> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretContactService,
  ) {
    super('IndretContactPartialUpdate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.IndretContact> {
    ...
    return this._submit('__model.IndretContact', result, 'data', value, true );
  }
