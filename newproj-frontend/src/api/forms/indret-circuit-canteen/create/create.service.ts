...
@Injectable()
export class IndretCircuitCanteenCreateFormService extends YASAGPostFormService<__model.IndretCircuitCanteen> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretCircuitCanteenService,
  ) {
    super('IndretCircuitCanteenCreate', apiConfigService, ngZone);
