...
@Injectable()
export class IndretCircuitCanteenPartialUpdateFormService extends YASAGPostFormService<__model.IndretCircuitCanteen> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretCircuitCanteenService,
  ) {
    super('IndretCircuitCanteenPartialUpdate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.IndretCircuitCanteen> {
    ...
    return this._submit('__model.IndretCircuitCanteen', result, 'data', value, true );
  }
