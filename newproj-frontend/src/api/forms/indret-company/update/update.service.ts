...
@Injectable()
export class IndretCompanyUpdateFormService extends YASAGPostFormService<__model.IndretCompany> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretCompanyService,
  ) {
    super('IndretCompanyUpdate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.IndretCompany> {
    ...
    return this._submit('__model.IndretCompany', result, 'null', value, false );
  }
