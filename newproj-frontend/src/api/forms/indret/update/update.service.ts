...
@Injectable()
export class IndretUpdateFormService extends YASAGPostFormService<__model.Indret> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretService,
  ) {
    super('IndretUpdate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.Indret> {
    ...
    return this._submit('__model.Indret', result, 'null', value, false );
  }
