...
@Injectable()
export class IndretSamplePointPartialUpdateFormService extends YASAGPostFormService<__model.SamplePoint> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretSamplePointService,
  ) {
    super('IndretSamplePointPartialUpdate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.SamplePoint> {
    ...
    return this._submit('__model.SamplePoint', result, 'data', value, true );
  }
