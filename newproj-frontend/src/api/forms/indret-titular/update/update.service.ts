...
@Injectable()
export class IndretTitularUpdateFormService extends YASAGPostFormService<__model.IndretTitular> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretTitularService,
  ) {
    super('IndretTitularUpdate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.IndretTitular> {
    ...
    return this._submit('__model.IndretTitular', result, 'null', value, false );
  }
