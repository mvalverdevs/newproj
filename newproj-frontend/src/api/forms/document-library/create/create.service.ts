...
@Injectable()
export class DocumentLibraryCreateFormService extends YASAGPostFormService<__model.DocumentLibrary> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: DocumentLibraryService,
  ) {
    super('DocumentLibraryCreate', apiConfigService, ngZone);
    this.form = new FormGroup({
      data: new FormGroup({
        ...
        document: new FormControl({value: undefined, disabled: false}, [Validators.required]),
