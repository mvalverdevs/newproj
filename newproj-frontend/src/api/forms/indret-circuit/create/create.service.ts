...
@Injectable()
export class IndretCircuitCreateFormService extends YASAGPostFormService<__model.IndretCircuit> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretCircuitService,
  ) {
    super('IndretCircuitCreate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.IndretCircuit> {
    ...
    return this._submit('__model.IndretCircuit', result, 'null', value, false );
  }
