...
@Injectable()
export class IndretActionPartialUpdateFormService extends YASAGPostFormService<__model.IndretAction> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: IndretActionService,
  ) {
    super('IndretActionPartialUpdate', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<__model.IndretAction> {
    ...
    return this._submit('__model.IndretAction', result, 'data', value, true );
  }
