...
import { BCNMatchMediaService } from '@bcn/services/match-media.service';

@Directive({
    selector: '.inner-scroll'
})
export class BCNInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {BCNMatchMediaService} _bcnMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _bcnMediaMatchService: BCNMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._bcnMediaMatchService.onMediaChange
