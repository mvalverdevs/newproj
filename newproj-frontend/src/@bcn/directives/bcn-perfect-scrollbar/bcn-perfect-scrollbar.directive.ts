...
@Directive({
    selector: '[bcnPerfectScrollbar]'
})
export class BCNPerfectScrollbarDirective implements AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set bcnPerfectScrollbarOptions(value)
    {
        // Merge the options
        this._options = _.merge({}, this._options, value);
    }

    get bcnPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.bcnPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.bcnPerfectScrollbarOptions
        });
    }
