import { ChangeDetectorRef, Component, ElementRef, HostBinding, HostListener, Input, OnDestroy, OnInit, Renderer2, RendererStyleFlags2 } from '@angular/core';
import { animate, AnimationBuilder, AnimationPlayer, style } from '@angular/animations';
import { MediaObserver } from '@angular/flex-layout';
import {Subject, takeUntil} from 'rxjs';

import { BCNSidebarService } from './sidebar.service';
import { BCNMatchMediaService } from '../../services/match-media.service';
...
export class BCNSidebarComponent implements OnInit, OnDestroy
{
     ...
     * @param {BCNMatchMediaService} _bcnMatchMediaService
    ...
    constructor(
        ...
        private _bcnMatchMediaService: BCNMatchMediaService,
    ...
    private _setupLockedOpen(): void
    {
        ...
        this._bcnMatchMediaService.onMediaChange
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe(() => {
