# Generated by Django 4.2.3 on 2023-09-26 19:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('superadmin', 'Superadministrador'), ('admin', 'Administrador'), ('referent', 'Referent'), ('manager', 'Gestor'), ('query', 'Consulta')], max_length=32, unique=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='user',
            name='roles',
            field=models.ManyToManyField(to='user.userroles'),
        ),
        migrations.AddField(
            model_name='user',
